#Topic Modeling and Text Summerization on text data
...
# Importing the Text data set into Python
with open('C:/Users/kaval/OneDrive/Desktop/Assignments/NLP/NLP-TM.txt', 'r', encoding = "latin8") as file:
    data_text = file.read()
...
data_text = data_text.text.apply(preprocess_string).tolist()
...
def get_coherence_values(start, stop):
    for num_topics in range(start, stop):
        ...
        coherence = calculate_coherence_score(data_text, dictionary, ldamodel)
        yield coherence

#Applying coherence scores
min_topics, max_topics = 7,11
...
#Summarization for the Text data set
import nltk
...
#Opening the Text data set into Python
with open('D:/Muka Data Science/Assignments/13/NLP-TM', 'r') as file:
    data_text = file.read()
data_text

#Appling summerization function to the Text data set
len(sent_tokenize(data_text))

summarize(data_text)
#Summerising the second sentence
summarize(data_text, num_sentences=2)
